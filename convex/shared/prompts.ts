...
export const generateSearchQuerySystem = [
  ...
  '- Only add exclusion filters (-India -Bangalore -USA -Canada -Asia -Africa) when a specific region or country is mentioned in the prompt. Do NOT add exclusions for global searches.',,
  '',
  ...
  '',
  'Step 8 — Optional precision signal:',
  '- If space allows, add one of these ATS page signals (they appear on real job listing pages):',
  '  ("job description" OR "apply now" OR "responsibilities")',
  '',
  'Step 9 — Constraints:',
  '- Keep under 380 characters.',
